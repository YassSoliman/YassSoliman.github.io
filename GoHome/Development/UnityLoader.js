...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 19492, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(19492, 30812, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(30812, 44180, 0, 0).open('GET', '/level0');
    new DataRequest(44180, 57548, 0, 0).open('GET', '/level1');
    new DataRequest(57548, 70916, 0, 0).open('GET', '/level2');
    new DataRequest(70916, 84284, 0, 0).open('GET', '/level3');
    new DataRequest(84284, 89168, 0, 0).open('GET', '/level4');
    new DataRequest(89168, 89189, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(89189, 89528, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(89528, 154228, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(154228, 159092, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(159092, 163956, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(163956, 168820, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(168820, 173336, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(173336, 1654144, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1654144, 3151516, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3151516, 3212244, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(3212244, 3239869, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
